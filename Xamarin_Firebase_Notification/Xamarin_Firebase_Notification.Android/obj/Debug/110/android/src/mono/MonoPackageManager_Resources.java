...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Xamarin_Firebase_Notification.Android.dll" comes first in this list. */
		"Xamarin_Firebase_Notification.Android.dll",
		"FormsViewGroup.dll",
		...
		"Xamarin_Firebase_Notification.dll",
	};
